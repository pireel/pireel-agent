...
- Background music → toolbar 音乐 button: upload or generate a music bed for the whole video (level auto-balances against the narration loudness and ducks under speech; volume/duck/loop knobs; or ask the agent: set_bgm). The same panel has 响度统一 — align inserted clips' loudness to the main narration.
